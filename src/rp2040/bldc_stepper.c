...
// // 1° electrical table, 360 elements,3174 range
const int pwmSin[] = {1701,1789,1878,1967,2055,2143,2231,2317,2403,2488,2573,2656,2738,2818,2898,2976,3000,3024,3045,3066,3084,3101,3116,3129,3141,3150,3158,3165,3169,3172,3173,3172,3169,3165,3158,3150,3141,3129,3116,3101,3084,3066,3045,3024,3000,2976,3000,3024,3045,3066,3084,3101,3116,3129,3141,3150,3158,3165,3169,3172,3173,3172,3169,3165,3158,3150,3141,3129,3116,3101,3084,3066,3045,3024,3000,2976,2898,2818,2738,2656,2573,2488,2403,2317,2231,2143,2055,1967,1878,1789,1701,1612,1523,1434,1346,1258,1170,1084,998,913,828,745,663,583,503,426,401,377,356,335,317,300,285,272,260,251,243,236,232,229,228,229,232,236,243,251,260,272,285,300,317,335,356,377,401,426,401,377,356,335,317,300,285,272,260,251,243,236,232,229,228,229,232,236,243,251,260,272,285,300,317,335,356,377,401,426,503,583,663,745,828,913,998,1084,1170,1258,1346,1434,1523,1612};
...
extern struct gpio_pwm gpio_pwm_setup_bldc(uint8_t pin, uint32_t cycle_time, uint8_t val);
...
void bldc_init(struct stepper *s, uint32_t pin) {
    ...
    if (pin == CONFIG_BLDC_PWM0A) {
        ...
        s->pinU = gpio_pwm_setup_bldc(CONFIG_BLDC_PWM0A, PWM_VALUE, 0);
        s->pinV = gpio_pwm_setup_bldc(CONFIG_BLDC_PWM0B, PWM_VALUE, 0);
        s->pinW = gpio_pwm_setup_bldc(CONFIG_BLDC_PWM0C, PWM_VALUE, 0);
